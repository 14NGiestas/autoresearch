...
A_OURS, ABAND_LO, ABAND_HI, A_CHINCHILLA, A_KAPLAN = 0.458, 0.315, 0.482, 0.28, 0.095
...
def main():
    ...
    o.append(f'<rect x="{X(0.008):.0f}" y="{Y(ABAND_HI):.0f}" width="{X(0.80)-X(0.008):.0f}" '
             f'height="{abs(Y(ABAND_LO)-Y(ABAND_HI)):.0f}" fill="#e6edf3" opacity="0.10"/>')
    o.append(f'<text x="{X(0.60):.0f}" y="{Y(ABAND_LO)+14:.0f}" fill="#e6edf3" font-size="9" '
